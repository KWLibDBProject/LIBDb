...
var booksList = preloadOptionsList('core/ref_topics/ref.topics.action.getoptionlist.php?lang=uk&withoutid');

BuildSelector('select_with_topic', booksList, 0);

url = "core/ajax.frontend.php?actor=load_articles_selected_by_query&lang=uk&book="/*plus_book_id*/;
