var topicsList = preloadOptionsList('ajax.php?actor=get_topics_as_optionlist&lang=ru');
var booksList = preloadOptionsList('ajax.php?actor=get_books_as_optionlist&lang=ru');
var lettersList = preloadOptionsList('ajax.php?actor=get_letters_as_optionlist&lang=ru');

BuildSelector('letter', lettersList, 0);
BuildSelector('book', booksList, 0);
BuildSelector('topic', topicsList, 0);

url = "ajax.php?actor=load_articles_by_query&lang=ru";
