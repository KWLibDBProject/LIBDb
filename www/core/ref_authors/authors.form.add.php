...
<form action="authors.action.insert.php" method="post" enctype="multipart/form-data" id="form_edit_author">
    <button type="button" class="button-large" id="button-exit"><strong>ВЕРНУТЬСЯ К СПИСКУ АВТОРОВ</strong></button>
    <button type="submit" class="button-large" ><strong>ДОБАВИТЬ АВТОРА</strong></button>
    <hr>
