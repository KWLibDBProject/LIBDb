...
VALUES (1, 'Международная редакционная коллегия', 5, ''),
       (2, 'Ответственный секретарь', 6, 'Горохолинская А.Н. '),
       (3, 'Редакционная коллегия', 4, ''),
       (4, 'Заместитель главного редактора', 3, ''),
       (5, 'Главный редактор журнала', 2, 'Маевский Дмитрий Андреевич '),
       (6, 'Редактор', 8, 'Боброва Полина Федоровна (г. Киев)'),
       (7, 'Почетный главный редактор журнала', 1, 'Герасимяк Ростислав Павлович'),
       (8, 'Ответственный секретарь', 7, 'Горохолинская А.Н. ');
